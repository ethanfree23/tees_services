...
const stats = [
  ...
  { id: 3, name: 'Project success rate', value: '100%' },
      ...
      <main>
        ...
        <div className="mt-32 sm:mt-56">
          ...
          <div className="relative overflow-hidden pt-16">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <img
                src="https://www.zygomarkhandymen.co.za/resources/Pronto-Handyman-Services-Pictures.png"
                alt="App screenshot"
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              ...
              <span>in the Greater Conroe area</span>
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Committed to delivering exceptional service to homeowners across the region with unparalleled expertise and meticulous attention to detail.
            </p>
          </div>
        ...
        <div className="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
              Let's get started with a simple conversation and see if it makes sense to move forward.
            </p>
